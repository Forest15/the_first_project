...
public class UserCreatingModel implements Serializable {
    ...
    public UserCreatingModel(UserCreatingModel.Builder builder){
    ...
    public static class Builder{
        ...
        public UserCreatingModel build(){
            return new UserCreatingModel(this);
        }
    }
}
